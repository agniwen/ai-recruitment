...
describe("permission matrix cross-cut", () => {
  ...
  const cases: [keyof typeof roles, string, string, boolean][] = [
    ...
    ["member", "page", "preRegistrations", false],
    ["admin", "page", "preRegistrations", true],
    ["owner", "page", "preRegistrations", true],
    ...
    ["admin", "page", "calendar", true],
    ["noAccess", "page", "chat", false],
    ["noAccess", "page", "resumes", false],
    ["noAccess", "page", "calendar", false],

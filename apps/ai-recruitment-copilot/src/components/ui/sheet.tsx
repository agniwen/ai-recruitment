...
function SheetOverlay({ className, ...props }: SheetPrimitive.Backdrop.Props) {
  return (
    <SheetPrimitive.Backdrop
      ...
      className={cn(
        "coss-overlay-motion fixed inset-0 z-50 bg-background/80 backdrop-blur-sm transition-opacity duration-[var(--duration-fast)] ease-[var(--ease-smooth-out)] data-instant:transition-none data-starting-style:opacity-0 data-ending-style:opacity-0 data-ending-style:duration-[var(--duration-quick)] motion-reduce:transition-none",
        className,
      )}
      {...props}
    />
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
          "coss-overlay-motion fixed z-50 flex flex-col gap-4 bg-background shadow-sm transition-transform duration-[var(--duration-slow)] ease-[var(--ease-smooth-out)] data-instant:transition-none data-ending-style:duration-[var(--duration-medium)] motion-reduce:transition-none",
          side === "right" &&

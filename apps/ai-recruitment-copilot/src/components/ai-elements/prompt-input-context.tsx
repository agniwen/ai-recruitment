...
import type { ComponentProps, Dispatch, PropsWithChildren, RefObject, SetStateAction } from "react";
...
export function buildManagedAttachment(file: File): ManagedAttachment {
  return {
    filename: file.name,
    id: nanoid(),
    mediaType: file.type,

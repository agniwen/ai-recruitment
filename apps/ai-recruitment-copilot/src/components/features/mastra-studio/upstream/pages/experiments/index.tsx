...
import {
  ...
  NoExperimentsInfo,
} from "@/components/features/mastra-studio/upstream/domains/experiments";
import { useReviewSummary } from "@/components/features/mastra-studio/upstream/domains/review";
import { buildReviewByExperimentMap } from "@/components/features/mastra-studio/upstream/domains/review/review-maps";
...
export default function Experiments() {
  ...
  const reviewByExperiment = useMemo(
    () => buildReviewByExperimentMap(reviewSummary),
    [reviewSummary],
  );

...
import { CopySkillDialog } from "@/components/features/mastra-studio/upstream/domains/agent-builder/components/skill-list/copy-skill-dialog";
import { SkillFavoriteButton } from "@/components/features/mastra-studio/upstream/domains/agent-builder/components/skill-list/skill-favorite-button";
import { useCopySkill } from "@/components/features/mastra-studio/upstream/domains/agent-builder/hooks/use-copy-skill";
      ...
      {copyOpen && (
        <CopySkillDialog
          ...
          onConfirm={async (name) => {
            try {
              const created = await copySkill.mutateAsync({ name, source: skill });
              setCopyOpen(false);

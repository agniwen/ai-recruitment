...
import { DeleteSkillPanelButton } from "@/components/features/mastra-studio/upstream/domains/agent-builder/components/skill-edit/delete-skill-action";
import { SkillBuilderMobileMenu } from "@/components/features/mastra-studio/upstream/domains/agent-builder/components/skill-edit/skill-builder-mobile-menu";
import { VisibilitySelect } from "@/components/features/mastra-studio/upstream/domains/agent-builder/components/skill-edit/visibility-select";
...
import { useAutosaveSkill } from "@/components/features/mastra-studio/upstream/domains/agent-builder/hooks/use-autosave-skill";
...
import { useStarterUserMessage } from "@/components/features/mastra-studio/upstream/domains/agent-builder/hooks/use-starter-user-message";
import { useStoredSkill } from "@/components/features/mastra-studio/upstream/domains/agent-builder/hooks/use-stored-skill";
import { SkillWorkspaceLayout } from "@/components/features/mastra-studio/upstream/domains/agent-builder/layouts/skill-workspace-layout";
import { SkillChatComposer } from "@/components/features/mastra-studio/upstream/domains/agents/components/agent-cms-pages/skill-chat-composer";
import { SkillSimpleForm } from "@/components/features/mastra-studio/upstream/domains/agents/components/agent-cms-pages/skill-simple-form";

...
const getTimelineLeftOffset = (panelWidth: number) =>
  Math.max(panelWidth - TIMELINE_LEFT_PANEL_OVERLAP, 0);
...
export const WorkflowLayout = ({
  ...
  const [leftPanelWidth, setLeftPanelWidth] = useState(() =>
    getTimelineLeftOffset(LEFT_PANEL_DEFAULT_WIDTH),
  );
  ...
  return (
    <div
      ...
      style={
        { "--workflow-left-panel-width": `${leftSlot ? leftPanelWidth : 0}px` } as CSSProperties
      }
    >

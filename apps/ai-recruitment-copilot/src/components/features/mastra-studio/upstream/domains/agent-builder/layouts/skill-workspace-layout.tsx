      ...
      >
        ...
        >
          <div className="flex h-full min-h-0 flex-col px-4 pt-4 pb-6 md:px-10">
            <div className="flex min-h-0 flex-1 flex-col md:max-w-[80ch] md:mx-auto w-full">
              {chat}
            </div>
          </div>
        </div>
        {showForm && (
          ...
          >
            ...
            >
              ...
              {deleteAction && (
                <div
                  className="border-t border-border1 px-4 pb-4 pt-4 md:px-6"
                  data-testid="skill-edit-delete-action"
                >
                  {deleteAction}
                </div>
              )}

...
import {
  toolProvidersFormSchema,
  validateToolProviders,
} from "@/components/features/mastra-studio/upstream/domains/tool-providers/schemas";
...
export const AgentBuilderEditFormSchema = z
  .object({
     ...
     * page; see `@/components/features/mastra-studio/upstream/domains/tool-providers/schemas`.
     */

...
import { ChatProvider } from "@/components/features/mastra-studio/upstream/lib/ai-ui/chat/chat-provider";
import { Thread } from "@/components/features/mastra-studio/upstream/lib/ai-ui/thread";
...
export const AgentChat = ({
  ...
  const emptyMessagesRef = useRef<{ threadId: string; messages: never[] }>({
    messages: [],
    threadId,
  });
  if (emptyMessagesRef.current.threadId !== threadId) {
    emptyMessagesRef.current = { messages: [], threadId };
  }

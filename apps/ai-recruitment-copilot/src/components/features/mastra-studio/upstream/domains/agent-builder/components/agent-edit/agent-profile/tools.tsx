...
export const Tools = ({ editable = true, availableAgentTools = [] }: ToolsProps) => {
  ...
  const { builtIn, providers, allToolkitIds, isProvidersLoading } =
    useProviderToolkitGroups(availableAgentTools);
  ...
  return (
    <div
      className="grid h-full min-h-0 grid-cols-[280px_minmax(0,1fr)]"
      data-testid="tools-card-picker"
    >

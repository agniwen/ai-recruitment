...
const WorkflowForEachProgress = ({
  foreachProgress,
}: Pick<WorkflowStepCardViewProps, "foreachProgress">) => {
  if (!foreachProgress) {
    return null;
  }
...
const WorkflowSleepDetails = ({
  duration,
  date,
}: Pick<WorkflowStepCardViewProps, "duration" | "date">) => (
  <>
    {duration && (
...
export const WorkflowStepCardView = ({
  ...
  const badgeProps = { canSuspend, date, duration, isForEach, isParallel, mapConfig, stepGraph };

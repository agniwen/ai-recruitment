...
type TracingOptions = NonNullable<
  ReturnType<typeof useTracingSettings>["settings"]
>["tracingOptions"];
...
export const WorkflowTracingRunOptions = ({
  ...
  const serializedTracingOptions = useMemo(
    () => stringifyTracingOptions(tracingOptions),
    [tracingOptions],
  );
  ...
  return (
    <div className="space-y-2 px-5 py-2">
      ...
      <CodeMirror
        ...
        className={cn(
          "overflow-y-scroll bg-surface3 rounded-lg overflow-hidden p-3",
          editorClassName,
        )}
      />

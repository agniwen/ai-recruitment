...
import { useAgentEditFormContext } from "@/components/features/mastra-studio/upstream/domains/agents/context/agent-edit-form-context";
...
function mcpClientToFormValues(mcpClient: {
  ...
  const serverType =
    (config as { type?: string }).type === "stdio" ? ("stdio" as const) : ("http" as const);

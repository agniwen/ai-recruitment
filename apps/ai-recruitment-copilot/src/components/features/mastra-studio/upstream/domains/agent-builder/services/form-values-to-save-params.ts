...
import { buildToolProvidersForSave } from "@/components/features/mastra-studio/upstream/domains/tool-providers/mappers/tool-providers-form-mappers";
...
export function formValuesToSaveParams(
  ...
  const metadata: Record<string, unknown> | undefined = values.avatarUrl

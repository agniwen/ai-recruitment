import type {
  AgentSettingsType,
  ModelSettings,
} from "@/components/features/mastra-studio/upstream/types";

interface AgentDefaultOptions {
  maxSteps?: number;
 ...
 */
export function buildAgentDefaultSettings(
  agent: { defaultOptions?: unknown } | null | undefined,
): AgentSettingsType {
  if (!agent) {

...
export interface AgentBuilderListProps {
...
export interface AgentBuilderListSkeletonProps {
  rows?: number;
  rowTestId?: string;
}
...
function AuthorBadge({ agent, className }: { agent: StoredAgentResponse; className?: string }) {
  ...
  return (
    <div
      ...
      data-testid="agent-builder-row-author"
    >

...
import { useStoredPromptBlocks } from "@/components/features/mastra-studio/upstream/domains/prompt-blocks";
...
export function PromptBlockPickerDialog({
  open,
  onOpenChange,
  onSelect,
}: PromptBlockPickerDialogProps) {

...
import { useAgentColor } from "@/components/features/mastra-studio/upstream/domains/agent-builder/contexts/agent-color-context";
  ...
  return (
    <div className="relative w-full h-full min-h-0 border border-border1 rounded-3xl overflow-hidden p-4">
      ...
      >
        ...
        {title && (
          <div
            className="border-b border-border1 px-6 pt-6 pb-4"
            data-testid="agent-step-title-section"
          >
        ...
        <div
          className={cn("min-h-0 overflow-y-auto", contentClassName)}
          data-testid="agent-step-content"
        >
          {children}
        </div>
        {showLastStepCtas ? (

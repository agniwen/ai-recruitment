    ...
    if (isSet) {
      ...
      form.setValue(
        "scorers",
        {
          ...selectedScorers,
          [scorerId]: {
            ...selectedScorers?.[scorerId],
            description: getOriginalDescription(scorerId),
          },
        },
        { shouldDirty: true },
      );
                  ...
                  <div key={scorer.value} className="flex flex-col">
                    <Entity className="bg-surface2">
                      <EntityContent>
                        ...
                        <EntityDescription>
                          <input
                            ...
                            value={
                              isSelected
                                ? (selectedScorers?.[scorer.value]?.description ??
                                  scorer.description)
                                : scorer.description
                            }
                      ...
                      {!readOnly && (
                        <Switch
                          checked={isSelected}
                          onCheckedChange={() => handleValueChange(scorer.value)}
                        />
                      )}
                    </Entity>
                  </div>

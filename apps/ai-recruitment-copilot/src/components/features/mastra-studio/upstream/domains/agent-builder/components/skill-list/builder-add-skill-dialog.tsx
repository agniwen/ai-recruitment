...
} from "@/components/features/mastra-studio/upstream/domains/agent-builder/hooks/use-builder-registries";
...
function parseSkillSource(topSource: string): { owner: string; repo: string } | null {
  ...
  const cleaned = topSource.replace(/^https?:\/\//, "").replace(/^github\.com\//, "");

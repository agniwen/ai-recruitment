...
import { getSkillOrigin } from "@/components/features/mastra-studio/upstream/domains/agent-builder/utils/skill-origin";

export interface SkillBuilderListProps {
...
export function SkillBuilderList({
  skills,
  search,
  onSkillClick,
  showFavorites = true,
}: SkillBuilderListProps) {

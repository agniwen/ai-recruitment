...
import { buildFormSnapshotInstructions } from "@/components/features/mastra-studio/upstream/domains/agent-builder/services/build-form-snapshot";
...
export const ConversationPanelProvider = ({
  ...
  const initialMessageToolsReady =
    toolsReady && (!features.model || !isLoadingModels) && !isLoadingIntegrationTools;
  ...
  const conversationContextValue = useMemo(
    () => ({ agentId, isLoading: isConversationLoading }),
  ...
  const starterMessageReady =
    initialMessageToolsReady && !isConversationLoading && !hasExistingConversation
      ? initialUserMessage
      : undefined;

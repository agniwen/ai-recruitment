...
const PAGE_PERMISSION_DESCRIPTIONS: Partial<Record<string, string>> = {
  aiReview:
    "控制 AI 分析审批页面入口和访问；查看待审简历还需 AI 分析审批的查看权限。实际审批需要 AI 分析审批的审批权限，不受简历来源或 ODC 负责范围限制。",
  calendar:
...
const RESOURCE_ACTION_DESCRIPTIONS: Partial<Record<PermissionResource, Record<string, string>>> = {
  aiReview: {
    approve:
      "允许审批当前工作区所有处于 AI 评价审核阶段的候选人，无需 ODC 身份或简历来源授权；审批时必须填写说明。",
    read: "允许查看当前工作区所有待审批候选人、候选人概览和 AI 评价，不受简历来源限制。",
  },
  auditLog: {

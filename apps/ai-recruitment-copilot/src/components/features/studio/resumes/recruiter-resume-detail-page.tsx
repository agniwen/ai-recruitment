import { resolveDefaultTab } from "./recruiter-resume-detail-search";
import type { ResumeDetailPageSearch } from "./recruiter-resume-detail-search";
...
export function RecruiterResumeDetailPage({
  ...
  onBack: () => void;
  recordId: string;
  routeSearch: ResumeDetailPageSearch;
}) {

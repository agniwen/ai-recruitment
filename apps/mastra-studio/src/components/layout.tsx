...
import {
  ...
  MainSidebarProvider,
  useMainSidebar,
} from "@mastra/playground-ui/components/MainSidebar";
...
function LayoutContent({ children }: { children: React.ReactNode }) {
  ...
  const shouldHideSidebar =
    isFetched && authCapabilities?.enabled && !isAuthenticated(authCapabilities);
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "h-full",
          shouldShowSidebar && "lg:grid lg:grid-cols-[auto_1fr] lg:grid-rows-[1fr]",
        )}
      >

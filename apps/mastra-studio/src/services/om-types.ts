 ...
 */
export interface OmAugmentation {
  disconnectedAt?: string;
  _state?: string;
}

export type AugmentData<T extends { data: unknown }> = Omit<T, "data"> & {
  data: T["data"] & OmAugmentation;
};
...
export interface OmCycleViewModel {
  cycleId: string;
  recordId?: string;

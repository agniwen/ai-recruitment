...
describe("AgentProfileToolsStep", () => {
  ...
  it("shows the selected tools count in the onboarding description", () => {
    editPageState.availableAgentTools = [
      { id: "weather", isChecked: true, name: "Weather", type: "tool" },
      { id: "calendar", isChecked: false, name: "Calendar", type: "tool" },
      { id: "agent-helper", isChecked: true, name: "Agent Helper", type: "agent" },
    ];

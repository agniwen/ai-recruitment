...
import {
  ...
  useAgentPrimitives,
} from "../../../../contexts/agent-primitives-context";
...
export const registerStepHandlers = ({
  ...
  server.use(
    ...
    http.get(`${BASE_URL}/api/stored/agents/${TEST_AGENT_ID}`, () =>
      HttpResponse.json(storedAgent),
    ),
    http.get(`${BASE_URL}/api/stored/agents/${TEST_AGENT_ID}/dependents`, () =>
      HttpResponse.json(noDependents),
    ),

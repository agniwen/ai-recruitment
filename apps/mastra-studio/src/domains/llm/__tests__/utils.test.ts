...
describe("findProviderById", () => {
  const providers = [
    { connected: true, id: "openai", name: "OpenAI" },
    { connected: true, id: "anthropic", name: "Anthropic" },
    { connected: true, id: "acme/custom", name: "ACME Custom" },
    { connected: true, id: "gateway1/shared-provider", name: "Gateway 1 Shared" },
    { connected: false, id: "gateway2/shared-provider", name: "Gateway 2 Shared" },
  ];

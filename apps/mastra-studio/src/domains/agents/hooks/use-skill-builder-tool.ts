...
export function useSkillBuilderTools(
  callbacks: SkillBuilderCallbacks,
  formStateRef: React.RefObject<SkillFormState>,
) {
      ...
      createTool({
        ...
        execute: async (input: any) => {
          ...
          if (typeof input?.description === "string") {
            cb.onDescriptionChange(input.description);
          }
        ...
        inputSchema: z.object({
          ...
          instructions: z
            ...
            .optional()
            .describe(
              "Detailed markdown instructions for the skill (purpose, workflow, rules, tone)",
            ),
          name: z
            .string()
            .optional()
            .describe('Short, descriptive skill name (e.g. "article-summarizer")'),
        }),

...
const baseFiles = [
  { content: "# Title\nDo X", id: "f1", name: "SKILL.md", type: "file" as const },
  { content: "MIT", id: "f2", name: "LICENSE", type: "file" as const },
];
    ...
    it("writes each skill file under the skills/ prefix recursively", async () => {
      ...
      expect(writes).toEqual(
        expect.arrayContaining([
          ...
          { content: "MIT", encoding: undefined, path: "skills/LICENSE", recursive: true },
        ]),
      );
    });
  });

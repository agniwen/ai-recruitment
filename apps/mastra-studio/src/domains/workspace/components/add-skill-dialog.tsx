                ...
                {isLoadingPopular || isSearching ? (
                  ...
                  <div className="p-2 space-y-1">
                    {displaySkills.map((skill) => {
                      ...
                      const selectedSkillUniqueId = selectedSkill
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            ...
                            "hover:bg-surface4",
                            selectedSkillUniqueId === skillUniqueId &&
                    ...
                    <div className="p-4 border-b border-border1 bg-surface3">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <h3 className="font-semibold text-neutral6 truncate">
                            {selectedSkill.name}
                          </h3>
              ...
              <div className="flex items-center justify-end gap-2">
                {isSelectedSkillInstalled &&
                  ...
                  (() => {
                    ...
                    const mount = writableMounts.find(
                      (m) => skillPath.startsWith(`${m.path}/`) || skillPath === m.path,
                    );
                    return mount ? (
                      <span className="text-xs text-icon4">Installed at {mount.path}</span>
                    ) : null;
                  })()}

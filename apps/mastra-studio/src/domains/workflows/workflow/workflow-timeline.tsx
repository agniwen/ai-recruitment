  ...
  return (
    ...
    >
      ...
      <Txt
        as="span"
        variant="ui-sm"
        className="w-20 justify-self-end text-right text-neutral3 tabular-nums"
      >
...
export function WorkflowTimeline() {
  ...
  const { selectedStepId, hoverStepId, setSelectedStepId, setHoverStepId } =
    useWorkflowSelectedStep();

  ...
  it("groups connections by authorId for admins with shared connections last", async () => {
    ...
    server.use(
      http.get(`${BASE_URL}/api/auth/me`, () =>
        HttpResponse.json({ id: "me", permissions: ["tool-providers:admin"] }),
      ),
      ...
      http.get(`${BASE_URL}/api/tool-providers/${PROVIDER}/connections`, () =>
        HttpResponse.json(adminConnections),
      ),
      http.delete(
        `${BASE_URL}/api/tool-providers/${PROVIDER}/connections/conn_a`,
        ({ request }) => {
    ...
    const headings = [
      ...container.querySelectorAll('[data-testid^="integration-author-group-"]'),
